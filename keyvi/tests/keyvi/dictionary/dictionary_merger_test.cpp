...
BOOST_AUTO_TEST_CASE(MergeFloatVectorDicts, *boost::unit_test::tolerance(0.00001)) {
  ...
  for (const auto& params : merge_configurations) {
    std::vector<std::pair<std::string, std::array<float, 5>>> test_data = {
    ...
    testing::TempDictionary dictionary = testing::TempDictionary(&test_data);

    std::vector<std::pair<std::string, std::array<float, 5>>> test_data2 = {
    ...
    testing::TempDictionary dictionary2 = testing::TempDictionary(&test_data2);
...
BOOST_AUTO_TEST_CASE(MergeIncompatibleFloatVectorDicts, *boost::unit_test::tolerance(0.00001)) {
  ...
  std::vector<std::pair<std::string, std::array<float, 10>>> test_data2 = {
